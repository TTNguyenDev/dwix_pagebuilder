    ...
    if (query) {
        ...
        collection = collection.filter((x) => {
          ...
          for (const filter of query.filters) {
            ...
            switch (operator) {
              ...
              default:
                throw new Error(
                  "Cannot translate operator into Firebase Realtime Database query."
                );
            }
          }
      ...
      if (query.orderingBy) {
        ...
        collection = collection.sort((x, y) => {
          ...
          const modifier =
            query.orderDirection === OrderDirection.accending ? 1 : -1;
    ...
    return new Promise<object>((resolve, reject) => {
      ...
      input.onchange = (e) => {
        ...
        reader.onload = async (readerEvent) => {
          ...
          const dataObject = contentString
