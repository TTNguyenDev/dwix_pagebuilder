...
type ContractMethodsType = {
  ...
  get_user_websites: ContractMethodType;
  get_lastest_projects: ContractMethodType;
  new_project: ContractMethodType;
  add_pages: ContractMethodType;
  delete_page: ContractMethodType;
  update_data: ContractMethodType;
};
